...
class ComponentPageManager {
    ...
    renderInstallationSection() {
        ...
        const basicInstallCommand = `npx claude-plugins@latest --${this.component.type}=${componentPath} --yes`;
    ...
    renderGlobalAgentSection(componentPath) {
        const globalAgentSection = document.getElementById('globalAgentSection');
        const globalAgentCommand = `npx claude-plugins@latest --create-agent ${componentPath}`;
    ...
    renderE2BSandboxSection(componentPath) {
        const e2bSandboxSection = document.getElementById('e2bSandboxSection');
        const e2bSandboxCommand = `npx claude-plugins@latest --sandbox e2b --agent=${componentPath} --prompt "your development task"`;
