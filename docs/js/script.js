...
function generateTemplateCards() {
    ...
    Object.entries(templatesData).forEach(([languageKey, languageData]) => {
        ...
        const baseCard = createTemplateCard(languageKey, languageData, 'none', {
            ...
            command: `npx claude-plugins@latest --template=${languageKey} --yes`
        });
                    ...
                    <div class="contribute-steps">
                        <div class="contribute-step">
                            ...
                            <div class="step-content-contrib">
                                ...
                                <p>Go to the <a href="https://github.com/lifangda/claude-plugins" target="_blank">main repository</a> and click "Fork" to create your own copy.</p>
                                <div class="step-command">
                                    <code>git clone https://github.com/YOUR_USERNAME/claude-plugins.git</code>
                                    <button class="copy-btn" onclick="copyToClipboard('git clone https://github.com/YOUR_USERNAME/claude-plugins.git')">Copy</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="step-content-contrib">
                                ...
                                <div class="claude-prompt">
                                    ...
                                    <div class="prompt-text">
                                        <pre>I want to contribute a new template to the claude-plugins repository. 
...
Please analyze the existing templates in the repository first to understand the structure and patterns, then create the new template following the same conventions.</pre>
                    ...
                    <div class="contribute-footer">
                        <div class="help-section">
                            <h4>Need Help?</h4>
                            <p>Check out <a href="https://github.com/lifangda/claude-plugins/blob/main/CONTRIBUTING.md" target="_blank">CONTRIBUTING.md</a> or open an issue on GitHub.</p>
                        </div>
                    </div>
                </div>
            </div>
...
function getGithubFolderUrl(languageKey, frameworkKey) {
    const baseUrl = 'https://github.com/lifangda/claude-plugins/tree/main/cli-tool/templates';
...
function getGithubFileUrl(languageKey, frameworkKey, filePath) {
    const baseUrl = 'https://github.com/lifangda/claude-plugins/blob/main/cli-tool/templates';
...
function generateInstallCommand(component) {
    if (component.type === 'agent') {
        return `npx claude-plugins@latest --agent=${component.name} --yes`;
    } else if (component.type === 'command') {
        return `npx claude-plugins@latest --command=${component.name} --yes`;
    } else if (component.type === 'mcp') {
        // Remove .json extension from MCP names for the command
        const mcpName = component.name.replace(/\.json$/, '');
        return `npx claude-plugins@latest --mcp=${mcpName} --yes`;
    }
    return `npx claude-plugins@latest`;
}
                    ...
                    <div class="contribute-steps">
                        ...
                        <div class="contribute-step">
                            ...
                            <div class="step-content-contrib">
                                ...
                                <div class="step-command">
                                    <a href="https://github.com/lifangda/claude-plugins/tree/main/cli-tool/components/${type}" target="_blank" class="github-folder-link">
                                        📁 View existing ${type}
                                    </a>
                                </div>
                            </div>
