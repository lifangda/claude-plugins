...
function showBanner() {
  ...
  console.log(
    ...
    chalk.gray(`\n                             v${pkg.version}\n\n`) +
    chalk.blue('🌐 Plugins: ') + chalk.underline('https://github.com/lifangda/claude-plugins') + '\n' +
    chalk.blue('📖 Documentation: ') + chalk.underline('https://github.com/lifangda/claude-plugins') + '\n'
  );
}
