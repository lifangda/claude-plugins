...
class ConsoleBridge extends EventEmitter {
      ...
      exec('ps aux | grep -E "claude[^-]|Claude" | grep -v grep', (error, stdout) => {
        ...
        const processes = stdout.split('\n')
          ...
          .filter(proc => 
            ...
            !proc.command.includes('claude-plugins') &&
  ...
  "../../../../../../../.claude/projects/-Users-danipower-Proyectos-Github-claude-plugins", include: "*.jsonl")

Do you want to proceed?
❯ 1. Yes
  2. Yes, and add /Users/danipower/.claude/projects/-Users-danipower-Proyectos-Github-claude-plugins as a working directory for this session
