...
For sophisticated multi-agent orchestration, use the [Claude Code Commands](https://github.com/lifangda/claude-plugins) collection which provides 52 pre-built slash commands:
...
- [Claude Code Commands](https://github.com/lifangda/claude-plugins)
