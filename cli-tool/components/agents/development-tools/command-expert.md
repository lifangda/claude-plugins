---
name: command-expert
description: CLI command development specialist for the claude-plugins system. Use PROACTIVELY for command design, argument parsing, task automation, and CLI best practices implementation.
