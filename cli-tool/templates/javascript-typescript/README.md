...
npx claude-plugins --language javascript-typescript
```
...
cp claude-plugins/javascript-typescript/CLAUDE.md your-project/
...
**Ready to supercharge your JavaScript/TypeScript development?** Run `npx claude-plugins --language javascript-typescript` in your project now!